package com.multirest.vishalverma.doodhmaster.CalendarPkg;
...
public class DialogAdaptorStudent extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.cal_row_addapt, null, true);
        ...
        tvTitle.setText("Date : "+alCustom.get(position).getTitles());
        tvSubject.setText("Morning : "+alCustom.get(position).getSubjects());
        tvDuedate.setText("Due Date : "+alCustom.get(position).getDuedates());
        tvDescription.setText("Evening : "+alCustom.get(position).getDescripts());
